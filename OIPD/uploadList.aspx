<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="uploadList.aspx.cs" Inherits="OIPD.uploadList" %>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  CssClass="w3-table-all" DataKeyNames="patientno" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Upload">
                <ItemTemplate>
                    <a href="upload.aspx?sno=<%# Eval("patientno") %>" >Upload Documents</a>
                </ItemTemplate>
            </asp:TemplateField>
