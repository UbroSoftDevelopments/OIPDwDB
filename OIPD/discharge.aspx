<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="discharge.aspx.cs" Inherits="OIPD.discharge" %>
 ...
 <div class="w3-container">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  CssClass="w3-table-all"
        ...
        <Columns>
          ...
          <ItemTemplate>
          <a href="dischargePatient.aspx?patientno=<%# Eval("patientno") %>" >Discharge</a>
          </ItemTemplate>
          </asp:TemplateField>
