<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OpdPatientsList.aspx.cs" Inherits="OIPD.OpdPatientsList" %>
 ...
 <div class="w3-container">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  CssClass="w3-table-all"
        ...
        <Columns>
          ...
          <ItemTemplate>
          <a href="printReceipt.aspx?sno=<%# Eval("patientno") %>" target="_blank" >Print</a>
          </ItemTemplate>
          </asp:TemplateField>
