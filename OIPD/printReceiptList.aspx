<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="printReceiptList.aspx.cs" Inherits="OIPD.printReceiptList" %>
 ...
 <div class="w3-container">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  CssClass="w3-table-all"
        ...
        <Columns>
          ...
          <ItemTemplate>
          <a href="printPaymentBill.aspx?patientno=<%# Eval("patientno") %>" target="_blank" >Print Bill</a>
          </ItemTemplate>
          </asp:TemplateField>
