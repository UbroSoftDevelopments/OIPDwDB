<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="printIPD.aspx.cs" Inherits="OIPD.WebForm1" %>
...
<tr>
    <td>
        ...
        <tr>
            <td colspan="6"><center><label class="w3-large w3-center w3-xlarge w3-border w3-border-black"><b>&nbsp;&nbsp;IPD FORM&nbsp;&nbsp;</b></label></center></td>
        </tr>
        <tr>
        ...
        <tr>
        <td colspan="6"><center><label class="w3-large w3-center w3-xlarge w3-border w3-border-black"><b>&nbsp;&nbsp;ADMIT DETAILS&nbsp;&nbsp;</b></label></center></td>
        </tr>
        <tr>
            <td class="w3-left heading"><b>Reason -:</b></td>
            <td colspan="3" class="details"><asp:Label ID="lblReason" CssClass="w3-left" runat="server"></asp:Label></td>
            <td class="w3-left heading"><b>Doctor Incharge -:</b></td>
            <td colspan="2" class="details"><asp:Label ID="lblDoctor" CssClass="w3-left" runat="server"></asp:Label></td>
        </tr>

        <tr>
            <td class="w3-left heading"><b>Ward No -:</b></td>
            <td class="details"><asp:Label ID="lblWardNo" CssClass="w3-left" runat="server"></asp:Label></td>
            <td class="w3-left heading"><b>Room No -:</b></td>
            <td class="details"><asp:Label ID="lblRoomNo" CssClass="w3-left" runat="server"></asp:Label></td>
            <td class="w3-left heading"><b>Bed No -:</b></td>
            <td class="details"><asp:Label ID="lblBedNo" CssClass="w3-left" runat="server"></asp:Label></td>
        </tr>
        <tr>
            <td><b>Amount -: </b></td>
