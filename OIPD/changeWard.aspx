<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="changeWard.aspx.cs" Inherits="OIPD.changeWard" %>
        ...
        <Columns>
            ...
            <asp:BoundField DataField="lastname" HeaderText="Last Name" 
                ...
                <asp:TemplateField HeaderText="Age">
                    <ItemTemplate>
                        <%# Eval("ageyears")+"Y "+Eval("agemonths")+"M"%>
                    </ItemTemplate>
                </asp:TemplateField>
          ...
          <asp:TemplateField HeaderText="Department Transfer">
          <ItemTemplate>
          <a class="w3-btn w3-gray" href="changeDepartment.aspx?patientno=<%# Eval("patientno") %>" >Change Department</a>
          </ItemTemplate>
          </asp:TemplateField>
          <asp:TemplateField HeaderText="Ward Transfer">
          <ItemTemplate>
          <a class="w3-button w3-gray" href="patientTransfer.aspx?patientno=<%# Eval("patientno") %>" >Transfer Ward</a>
          </ItemTemplate>
          </asp:TemplateField>
