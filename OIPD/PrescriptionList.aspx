<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PrescriptionList.aspx.cs" Inherits="OIPD.PrescriptionList" %>
...
<div class=" w3-container w3-card-4 w3-padding w3-center w3-centered w3-border w3-border-teal">
  ...
  <a href="prescription.aspx"><div class="w3-center w3-round-xxlarge w3-large w3-btn w3-teal">Not a Patient</div></a>
  <br /><br />
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  CssClass="w3-table-all"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Date of Entry">
                <ItemTemplate>
                    <%# IOPD.DataManager.DateUtilities.onlyDateFormat(Eval("dateofentry"))%>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Age">
                <ItemTemplate>
                    <%# (Eval("ageyears")) +"Y "+ (Eval("agemonths")) +"M "+ (Eval("agedays")) +"D"%>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Print">
                <ItemTemplate>
                    <a href="printPad.aspx?sno=<%# Eval("patientno") %>&treatNo=0" target="_blank" >Print Prescription</a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
